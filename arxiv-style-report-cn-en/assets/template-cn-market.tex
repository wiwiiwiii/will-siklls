...
%--------------------------------------------------------------------------------
\geometry{a4paper,left=20mm,right=20mm,top=18mm,bottom=22mm,headheight=12pt,headsep=10pt,footskip=16pt}
...
\renewcommand{\@toptitlebar}{\hrule height 1.2\p@\vskip 0.14in\vskip-\parskip}
\renewcommand{\@bottomtitlebar}{\vskip 0.16in\vskip-\parskip\hrule height 1.2\p@\vskip 0.04in}
\makeatother
...
\date{\today}
\renewcommand{\shorttitle}{市场调研报告}
...
\keywords{市场调研 \and 加权量化 \and 用户反馈}
